...
enum class Projection { TopDown, Isometric };
...
class Tilemap {
public:
  Tilemap(SDL_Renderer *renderer, const std::string &texturePath, int tileWidth,
  ...
  void LoadFog(
      const std::vector<int> &fogData); // 0: Hidden, 1: Explored, 2: Visible
